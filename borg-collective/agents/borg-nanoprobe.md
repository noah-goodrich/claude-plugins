...
0. **Project knowledge** from the brief (if the orchestrator supplied it) — read it FIRST and prefer
...
loads project context into normal sessions — without this brief you would re-derive known facts from
