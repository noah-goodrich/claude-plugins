...
We have been arguing about the search index for two sprints, so here is the writeup everyone asked for. It covers
the history, the failed attempts, and where the team landed.
